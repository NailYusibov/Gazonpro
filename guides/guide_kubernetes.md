...
2. Перейдите по сокету (комбинация IP и порта), полученному на предыдущем шаге + эндпоинт сваггера. Вы также можете перейти на http://localhost:{полученный порт}/swagger-ui/index.html, это приведет к тому же результату
